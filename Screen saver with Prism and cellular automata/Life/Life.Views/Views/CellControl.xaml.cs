...
namespace Ikc5.AutomataScreenSaver.Life.Views
{
	...
	/// https://ireznykov.com/2016/08/14/square-wpf-user-control/
	/// </summary>
	public partial class CellControl : UserControl
	{
		...
		public static readonly DependencyProperty StartColorProperty =
			DependencyProperty.Register(
				...
				typeof(Color),
				typeof(CellControl),
				new PropertyMetadata(Color.FromArgb(255, Colors.AliceBlue.R, Colors.AliceBlue.G, Colors.AliceBlue.B)));
